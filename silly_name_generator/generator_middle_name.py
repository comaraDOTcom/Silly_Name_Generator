...
def main():
    """
    Will generate silly with a middle name as well if a random number
    ...
    # used in this way?
    first = (
        "Bill", "Bob 'Stinkbug'", 'Bowel Noises', 'Boxelder', "Bud 'Lite' ",
        ...
        'Rock Candy', 'Schlomo', 'Scratchensniff', 'Scut', "Sid ",
    ...
    middle = (
        'Tinkie Winkie', 'Grunts', 'The', 'The Big News', 'The Squirts',
        'Baby Oil', 'Bad News', 'Big Burps', 'Beenie-Weenie'
    )
